...
MODULES_MASS = [88062, 147838, 73346, 80732, 89182, 86798, 145656, 53825, 79515, 78250,
...
def fuel_mass(m):
    global fuel_mass_counter
    if math.floor(m/3)-2 > 0:
        fuel_mass_counter+=math.floor(m/3)-2
        fuel_mass(math.floor(m/3)-2)
    else:
        return

for mass in MODULES_MASS:
    fuel_counter_upper+=math.floor(mass/3)-2    #Day 1 part 1
    fuel_mass(math.floor(mass/3)-2)             #Day 1 part 2

print(fuel_counter_upper)
print(fuel_counter_upper+fuel_mass_counter)
